      ...
      <div className="mx-auto w-full max-w-5xl text-center">
        ...
        <div className="mx-auto mt-10 flex w-full max-w-[896px] flex-col items-stretch gap-6 rounded-[16px] border border-white/10 bg-white/5 p-6 backdrop-blur-[2px] md:flex-row md:items-center md:justify-between md:p-[41px]">
          <div className="flex-1 border-l-4 border-[#489cd8] pl-6 text-left md:pl-9">
            <p className="max-w-[260px] text-[24px] font-medium leading-[30px] tracking-[-0.6px] text-white md:text-[30px] md:leading-[36px] md:tracking-[-0.75px]">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:gap-5">
            <button
              type="button"
              className="min-w-[200px] rounded-[6px] bg-[#f76d2f] px-8 py-[17px] text-center text-[14px] font-bold uppercase tracking-[1.4px] text-white shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]"
            >
              Building my home
            </button>
            <button
              type="button"
              className="min-w-[200px] rounded-[6px] border border-white/20 bg-white/10 px-8 py-[17px] text-center text-[14px] font-bold uppercase tracking-[1.4px] text-white"
            >
              Investment
            </button>
          </div>
